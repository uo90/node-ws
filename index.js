...
const UUID = process.env.UUID || '17e0498d-5cdc-41fa-ab95-835e2813b56b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '17e0498d-5cdc-41fa-ab95-835e2813b56b';            // 获取节点的订阅路径
